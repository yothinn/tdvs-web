...
@Component({
  selector: 'app-joborder-pdf',
  templateUrl: './joborder-pdf.component.html',
  styleUrls: ['./joborder-pdf.component.scss']
})
export class JoborderPdfComponent implements OnInit {
