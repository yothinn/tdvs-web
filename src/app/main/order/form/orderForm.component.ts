          ...
          "messages": [
            {
              ...
              "template": {
                ...
                "text": "ตามที่คุณได้ลงทะเบียนกับ รถธรรมธุรกิจ ไว้ เราจะเข้าไปที่บ้านคุณในวัน" + this.nameDate + "ที่: " + this.titleDate + " ซึ่งจะไม่สามารถระบุเวลาได้ ถ้าคุณอยู่บ้านตลอดทั้งวัน ก็สามารถกดยืนยันนัดหมายได้ แต่เราจะติดต่อไปอีกครั้งตอนที่ออกจากบ้านก่อนหน้า ก่อนจะเดินทางไปที่บ้านคุณอีกครั้งหนึ่ง ขอบคุณครับ ธรรมธุรกิจ"
              }
            }
          ]
        };
